  ...
  return (
    <div className="px-6 pt-2 pb-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* COURSE VIEWER */}
        <div className="flex-1 min-w-0 bg-white rounded-2xl p-4 sm:p-6 shadow-sm overflow-hidden">
          {/* Top Bar */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
            <div>
              ...
              <p className="text-gray-500 mt-1">YouTube Playlist</p>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-red-600 hover:bg-red-700 text-white px-5 py-3 rounded-xl transition text-center w-fit"
            >
              Open Playlist
            </a>
          </div>
          ...
          <iframe
            ...
            className="w-full h-[70vh] sm:h-[calc(100vh-220px)] rounded-2xl"
            allowFullScreen
          />
        </div>
      </div>
