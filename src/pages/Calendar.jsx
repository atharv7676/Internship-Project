  ...
  return (
    <div className="px-6 pt-2 pb-6 bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* LEFT SIDE */}
        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm w-full lg:w-auto overflow-x-auto">
          <Calendar
            onChange={setDate}
            value={date}
        ...
        <div className="flex-1 min-w-0 bg-white rounded-2xl p-4 sm:p-6 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <button
              onClick={addEvent}
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 sm:py-0 rounded-xl transition"
            >
              Add Event
            </button>
          </div>
          ...
          <div className="space-y-4">
            {selectedDateEvents.length === 0 ? (
              ...
              selectedDateEvents.map((event) => (
                <div
                  key={event.id}
                  className="border border-gray-200 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
                >
                  ...
                  {/* Event Badge */}
                  <div className="bg-red-100 text-red-600 px-4 py-2 rounded-full text-sm font-medium w-fit">
                    Important
                  </div>
                </div>
              ))
